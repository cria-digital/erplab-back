...
export class SimplificarAgendasConfirmeFigma1764676562354
  implements MigrationInterface
{
  name = 'SimplificarAgendasConfirmeFigma1764676562354';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Drop tabelas não mais utilizadas (conforme Figma)
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS "canais_integracao" CASCADE`);
    await queryRunner.query(
      `DROP TABLE IF EXISTS "profissionais_agendas" CASCADE`,
    );
    await queryRunner.query(
