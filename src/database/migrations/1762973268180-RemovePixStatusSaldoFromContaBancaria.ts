...
export class RemovePixStatusSaldoFromContaBancaria1762973268180
  implements MigrationInterface
{
  name = 'RemovePixStatusSaldoFromContaBancaria1762973268180';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."contas_bancarias_status_enum" AS ENUM('ativa', 'bloqueada', 'encerrada', 'inativa')`,
    );
    await queryRunner.query(
