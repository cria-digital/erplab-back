...
export class RemoverCamposRedundantesContasBancarias1761929526098
  implements MigrationInterface
{
  name = 'RemoverCamposRedundantesContasBancarias1761929526098';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`COMMENT ON TABLE "dados_bancarios" IS NULL`);
    await queryRunner.query(
