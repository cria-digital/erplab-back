...
export class CreateServicosSaudeTable1761932669271
  implements MigrationInterface
{
  name = 'CreateServicosSaudeTable1761932669271';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "servicos_saude" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "codigo" character varying(10) NOT NULL, "descricao" text NOT NULL, "codigo_grupo" character varying(10) NOT NULL, "nome_grupo" character varying(100) NOT NULL, "ativo" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_c59aa6be9993ae781acba5e00fd" UNIQUE ("codigo"), CONSTRAINT "PK_04e4bb4c221fa049d43dfde70ce" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "servicos_saude"`);
    await queryRunner.query(
      `CREATE INDEX "IDX_1c7842a1c9b419f3d5cc463e28" ON "convenios" ("codigo") `,
    );
    await queryRunner.query(
