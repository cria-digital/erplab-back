  ...
  async seed(): Promise<void> {
    ...
    const campos: CampoData[] = [
      ...
      },
      {
        ...
        descricao: 'Amostra biológica necessária para realização do exame',
        alternativas: [
          { texto: 'SANGUE', ordem: 1 },
          { texto: 'URINA 24 HORAS', ordem: 2 },
          { texto: 'URINA', ordem: 3 },
          { texto: 'FEZES', ordem: 4 },
          { texto: 'SANGUE CAPILAR', ordem: 5 },
          { texto: 'LÍQUIDOS BIOLÓGICOS', ordem: 6 },
          { texto: 'SALIVA', ordem: 7 },
          { texto: 'BIÓPSIA', ordem: 8 },
          { texto: 'DIVERSOS', ordem: 9 },
          { texto: 'ESCARRO', ordem: 10 },
          { texto: 'ESPERMA', ordem: 11 },
          { texto: 'SECREÇÃO URETRAL', ordem: 12 },
          { texto: 'SECREÇÃO VAGINAL', ordem: 13 },
          { texto: 'SANGUE E LÍQUOR', ordem: 14 },
          { texto: 'CÁLCULO VESICULAR', ordem: 15 },
          { texto: 'CÁLCULO URINÁRIO', ordem: 16 },
          { texto: 'MEDULA ÓSSEA', ordem: 17 },
          { texto: 'SECREÇÕES', ordem: 18 },
          { texto: 'SÊMEN', ordem: 19 },
          { texto: 'LÍQUOR', ordem: 20 },
          { texto: 'MUCO NASAL', ordem: 21 },
          { texto: 'RASPADO DE COLO UTERINO', ordem: 22 },
          { texto: 'SANGUE E URINA DE 24 HORAS', ordem: 23 },
          { texto: 'SANGUE E URINA', ordem: 24 },
          { texto: 'SECREÇÃO NASOFARÍNGEA E OROFARÍNGEA', ordem: 25 },
          { texto: 'SECREÇÃO NASAL E OROFARÍNGEA', ordem: 26 },
          { texto: 'SECREÇÃO OROFARINGE', ordem: 27 },
          { texto: 'SECREÇÃO NASAL', ordem: 28 },
          { texto: 'SECREÇÃO ANAL OU VAGINAL', ordem: 29 },
          { texto: 'FEZES OU SWAB ANAL', ordem: 30 },
          { texto: 'SECREÇÃO GENITAL OU URINA', ordem: 31 },
          { texto: 'URINA E PLASMA', ordem: 32 },
          { texto: 'SANGUE OU SALIVA', ordem: 33 },
          { texto: 'RASPADO DE COURO CABELUDO, CABELOS OU PELOS', ordem: 34 },
          { texto: 'LAVADO BRÔNQUICO', ordem: 35 },
          { texto: 'SECREÇÃO OCULAR', ordem: 36 },
          { texto: 'RASPADO DE PELE', ordem: 37 },
          { texto: 'RASPADO UNGUEAL', ordem: 38 },
          { texto: 'LÍQUIDO ORGÂNICO', ordem: 39 },
          { texto: 'SECREÇÃO GENITAL', ordem: 40 },
          { texto: 'SANGUE E SWAB ORAL', ordem: 41 },
          { texto: 'SECREÇÃO OU RASPADO OU BIÓPSIA', ordem: 42 },
          { texto: 'SECREÇÃO DA BORDA DA LESÃO', ordem: 43 },
          { texto: 'LÍQUIDO PLEURAL', ordem: 44 },
          { texto: 'RASPADO DE COURO CABELUDO', ordem: 45 },
          { texto: 'RASPADO DE UNHA', ordem: 46 },
          { texto: 'FITA GOMADA EM LÂMINA', ordem: 47 },
          { texto: 'LINFA', ordem: 48 },
          { texto: 'URINA AMOSTRA ISOLADA', ordem: 49 },
          { texto: 'SWAB ORAL', ordem: 50 },
          { texto: 'CABELOS OU PELOS', ordem: 51 },
          { texto: 'SECREÇÃO URETRAL/VAGINAL/URINA', ordem: 52 },
        ],
      },
      {
