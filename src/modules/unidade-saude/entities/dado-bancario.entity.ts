...
export class DadoBancario {
  ...
  @Column({ name: 'digito_agencia', type: 'varchar', length: 2, nullable: true })
  ...
  @Column({ name: 'tipo_conta', type: 'varchar', length: 20, default: 'CORRENTE' })
  ...
  // Relacionamentos
  @ManyToOne(() => UnidadeSaude, unidade => unidade.dadosBancarios, { onDelete: 'CASCADE' })
